...
CREATE TABLE ADMIN.tb_DATOS_CLIENTE
(
	ID_DATOS INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
...
CREATE TABLE ADMIN.tb_CIRCUNFERENCIA_CLIENTE
(
	ID_CIRCUNFERENCIA INT PRIMARY KEY IDENTITY (1,1) NOT NULL,
...
CREATE TABLE  ADMIN.tb_MEDICION_CLIENTE
(
	ID_MEDICION INT PRIMARY KEY IDENTITY (1,1) NOT NULL,
...
CREATE TABLE ADMIN.tb_RUTINA
(
	ID_RUTINA INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
	ID_CLIENTE INT NOT NULL,
	FECHA DATETIME NOT NULL,
...
(
	ID_EJERCICIO INT PRIMARY KEY IDENTITY (1,1) NOT NULL,
	NOMBRE_EJERCICIO VARCHAR(100) NOT NULL
)

CREATE TABLE ADMIN.tb_RUTINA_EJERCICIO
(
	...
	CONSTRAINT fk_id_rutina FOREIGN KEY (ID_RUTINA) REFERENCES ADMIN.tb_RUTINA(ID_RUTINA),
	CONSTRAINT fk_id_ejercicio FOREIGN KEY (ID_EJERCICIO) REFERENCES ADMIN.tb_EJERCICIO(ID_EJERCICIO)
)

CREATE TABLE ADMIN.tb_GRUPO_MUSCULAR
(
	ID_MUSCULAR INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
	NOMBRE_GRUPO_MUSCULAR VARCHAR(100) NOT NULL
)

CREATE TABLE ADMIN.tb_EJERCICIO_GRUPO
(
	ID_EJERCICIO INT NOT NULL,
	ID_GRUPO INT NOT NULL,
	CONSTRAINT pk_ejercicio_grupo PRIMARY KEY (ID_EJERCICIO, ID_GRUPO),
	CONSTRAINT fk_id_ejercicio_grupo FOREIGN KEY (ID_EJERCICIO) REFERENCES ADMIN.tb_EJERCICIO (ID_EJERCICIO),
	CONSTRAINT fk_id_grupo_ejercicio FOREIGN KEY (ID_GRUPO) REFERENCES ADMIN.tb_GRUPO_MUSCULAR(ID_MUSCULAR)
)
